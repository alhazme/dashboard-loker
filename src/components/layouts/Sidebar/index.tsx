...
import { HiOutlineClipboard, HiOutlineClipboardList } from 'react-icons/hi';
      ...
      <div className='space-y-4 py-4'>
        <div className='px-3 py-2'>
          ...
          <div className='space-y-3'>
            ...
            <Button variant={'ghost'} className='w-full hover:bg-red-200 text-red-500 hover:text-red-500 justify-start rounded-none'>
